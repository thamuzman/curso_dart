...
import 'package:aplicacion/classes/currency.dart';
import 'package:aplicacion/classes/language.dart';
import 'package:aplicacion/classes/regional_bloc.dart';
import 'package:aplicacion/classes/translations.dart';
...
class Pais {
  ...
  void imprimeFronteras() => borders.forEach((el) {
        // ignore: omit_local_variable_types
        String lower = el.toLowerCase();
        print('   ${lower[0].toUpperCase()}${lower.substring(1)}');
      });
}
